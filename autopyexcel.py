...
df = pd.read_excel(r'C:\Users\MOB\Documents\autopyexcel\dados.xlsx')
planilha = openpyxl.load_workbook(r'C:\Users\MOB\Documents\autopyexcel\dados.xlsx')
...
for i, consulta in enumerate(df['CPF']):
    ...
    navegador = webdriver.Chrome(r'C:\Users\MOB\Documents\autopyexcel\chromedriver.exe')
    navegador.get(link)
    navegador.implicitly_wait(10)
    navegador.find_element_by_xpath('//*[@id="login"]').send_keys("user")
    ...
    if len(consulta0) > 0:
        ...
        if len(consulta1) > 0 and consulta1[0].is_displayed():
            ...
            if len(consulta2) > 0 and consulta2[0].is_displayed():
                ...
                planilha.save(r'C:\Users\MOB\Documents\autopyexcel\dados.xlsx')
                print('HABILITADO')
                navegador.close()
